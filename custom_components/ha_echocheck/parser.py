...
def parse_echocheck_notification(
    ...
    # ── Tank level ─────────────────────────────────────────────────────────────
    # field_c is in units of 0.1 mm.  The sensor measures liquid height from
    # its mounting point (bottom of tank).  Divide by 10 to get mm, then
    # express as a percentage of the configured tank height.
